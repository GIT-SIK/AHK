...
;Gui, Add, GroupBox, x12 y159 w225 h110 , 설정 모드, 창 이름
Gui, Add, Text, x22 y182 w210 h20 vModeName, Client 모드
...
;Gui, Add, GroupBox, x12 y349 w225 h60 , 모드
Gui, Add, Radio, x22 y369 w70 h30 vScr, Screen
Gui, Add, Radio, x94 y369 w70 h30 vRel, Relative
Gui, Add, Radio, x172 y369 w60 h30 Checked vCli, Client


Gui, Add, Button, x162 y299 w60 h30 gin, 전송 [F7]
Gui, Add, Button, x85 y419 w90 h30 gbtn, 종료 [F3]
